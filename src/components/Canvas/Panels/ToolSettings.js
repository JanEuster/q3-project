...
class PanelShapeSelectorComponent extends BasePanelComponent {
  constructor(x, y, elementsX, diameter = 10, toolManager) {
    ...
    this.subComponents = [new PanelShapeButton(
      this.coords.x + this.margin,
      this.coords.y + this.margin + this.elementsY * (margin + diameter),
      this.diameter * 2,
      this.icon
  ...
  constructor(toolManager) {
    ...
    this.toolSettings = {
      ...
      "pencil": {components: [
        ...
        new PanelSlider(10, 180, 100, 20, (pos) => {this.toolManager.strokeWidthPencil = pos * 40})
      ], size: { height: 210 }
      },
      "eraser": {
        components: [
        new PanelText(10, 56, "Line Width", 13),
        new PanelSlider(10, 60, 100, 20, (pos) => {this.toolManager.strokeWidthEraser = pos * 40})
      ], size: {height: 160}},
      "text": {
        components: [
      ...
      "shapes": {
        ...
        new PanelSlider(10, 160, 100, 20, (pos) => { this.toolManager.borderWidth = pos * 40})
        ], size: { height: 210 }
      }
    }
  }
